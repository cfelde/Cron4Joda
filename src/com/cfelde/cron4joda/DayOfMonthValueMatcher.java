...
class DayOfMonthValueMatcher extends IntArrayValueMatcher {
     ...
     *
     * @param integers An ArrayList of Integer elements, one for every value
     * accepted by the matcher. The match() method will return true only if its
     * parameter will be one of this list or the last-day-of-month setting
     * applies.
     */
